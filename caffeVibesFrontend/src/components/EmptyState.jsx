  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="flex flex-col items-center justify-center py-24 md:py-32 px-10 text-center bg-text-main/[0.01] backdrop-blur-3xl border border-text-main/5 rounded-[4rem] w-full shadow-2xl relative overflow-hidden group mb-12"
      >
        ...
        <p className="text-sm md:text-lg text-text-muted/40 max-w-md leading-relaxed mb-12 font-bold uppercase tracking-[0.3em] px-4">
          {displayDesc}
        </p>
